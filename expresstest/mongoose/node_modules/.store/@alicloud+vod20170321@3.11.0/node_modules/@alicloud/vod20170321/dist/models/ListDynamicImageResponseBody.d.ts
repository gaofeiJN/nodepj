...
export declare class ListDynamicImageResponseBodyDynamicImageList extends $dara.Model {
    /**
     * @remarks
...
export declare class ListDynamicImageResponseBody extends $dara.Model {
    /**
     * @remarks
