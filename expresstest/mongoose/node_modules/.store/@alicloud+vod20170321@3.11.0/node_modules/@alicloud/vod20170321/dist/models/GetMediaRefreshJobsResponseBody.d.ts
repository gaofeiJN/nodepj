...
export declare class GetMediaRefreshJobsResponseBodyMediaRefreshJobs extends $dara.Model {
    /**
     * @remarks
...
export declare class GetMediaRefreshJobsResponseBody extends $dara.Model {
    /**
     * @remarks
