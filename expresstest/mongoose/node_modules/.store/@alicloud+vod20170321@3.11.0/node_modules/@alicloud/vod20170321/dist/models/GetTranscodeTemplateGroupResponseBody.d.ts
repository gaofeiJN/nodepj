...
export declare class GetTranscodeTemplateGroupResponseBodyTranscodeTemplateGroupTranscodeTemplateList extends $dara.Model {
    /**
     * @remarks
...
export declare class GetTranscodeTemplateGroupResponseBodyTranscodeTemplateGroup extends $dara.Model {
    /**
     * @remarks
...
export declare class GetTranscodeTemplateGroupResponseBody extends $dara.Model {
    /**
     * @remarks
     * The request ID.
     *
