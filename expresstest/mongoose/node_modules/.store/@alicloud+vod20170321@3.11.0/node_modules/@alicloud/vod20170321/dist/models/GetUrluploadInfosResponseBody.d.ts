...
export declare class GetURLUploadInfosResponseBodyURLUploadInfoList extends $dara.Model {
    /**
     * @remarks
...
export declare class GetURLUploadInfosResponseBody extends $dara.Model {
    /**
     * @remarks
