...
export declare class GetVideoListResponseBodyVideoListVideoSnapshots extends $dara.Model {
    snapshot?: string[];
    static names(): {
        [key: string]: string;
    };
...
export declare class GetVideoListResponseBodyVideoListVideo extends $dara.Model {
    /**
     * @remarks
...
export declare class GetVideoListResponseBodyVideoList extends $dara.Model {
...
export declare class GetVideoListResponseBody extends $dara.Model {
    /**
     * @remarks
