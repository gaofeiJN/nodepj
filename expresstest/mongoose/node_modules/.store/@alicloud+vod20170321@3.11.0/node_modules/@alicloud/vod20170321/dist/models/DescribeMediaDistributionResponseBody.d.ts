...
export declare class DescribeMediaDistributionResponseBodyMediaDistributionList extends $dara.Model {
    /**
     * @remarks
...
export declare class DescribeMediaDistributionResponseBody extends $dara.Model {
    /**
     * @remarks
