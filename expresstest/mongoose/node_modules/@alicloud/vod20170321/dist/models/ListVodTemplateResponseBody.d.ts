...
export declare class ListVodTemplateResponseBodyVodTemplateInfoList extends $dara.Model {
    /**
     * @remarks
...
export declare class ListVodTemplateResponseBody extends $dara.Model {
    /**
     * @remarks
