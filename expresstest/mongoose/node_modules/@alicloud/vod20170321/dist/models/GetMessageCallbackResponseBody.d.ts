...
export declare class GetMessageCallbackResponseBodyMessageCallback extends $dara.Model {
    /**
     * @remarks
...
export declare class GetMessageCallbackResponseBody extends $dara.Model {
    /**
     * @remarks
