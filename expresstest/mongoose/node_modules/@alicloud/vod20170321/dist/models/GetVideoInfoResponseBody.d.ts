...
export declare class GetVideoInfoResponseBodyVideoSnapshots extends $dara.Model {
    snapshot?: string[];
    static names(): {
        [key: string]: string;
    };
...
export declare class GetVideoInfoResponseBodyVideo extends $dara.Model {
    /**
     * @remarks
...
export declare class GetVideoInfoResponseBody extends $dara.Model {
    /**
     * @remarks
