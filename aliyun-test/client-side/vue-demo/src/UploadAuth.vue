        ...
        let uploader = new AliyunUpload.Vod({
          ...
          onUploadstarted: function (uploadInfo) {
            ...
            if (!uploadInfo.videoId) {
              let createUrl = 'http://127.0.0.1:3000/api/v1/video/CreateUploadVideo?title=%E8%BF%99%E6%98%AF%E4%B8%80%E4%B8%AA%E6%B5%8B%E8%AF%95%E8%A7%86%E9%A2%91&filename=2025%E5%B9%B408%E6%9C%8810%E6%97%A5@02_48_50-42239333.MP4'
              axios.get(createUrl).then(({alires}) => {
                let uploadAuth = alires.body.uploadAuth
                let uploadAddress = alires.body.uploadAddress
                let videoId = alires.body.videoId
